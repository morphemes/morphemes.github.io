...
lib.ssMetadata = [
		{name:"728x90_1_atlas_", frames: [[0,0,364,90],[0,184,100,34],[0,92,364,90]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["728x90_1_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._728x90_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/728x90_1_atlas_.png?1482946961323", id:"728x90_1_atlas_"}
	],
	preloads: []
};
