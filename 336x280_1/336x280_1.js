...
lib.ssMetadata = [
		{name:"336x280_1_atlas_", frames: [[170,0,168,280],[0,282,100,34],[0,0,168,280]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["336x280_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.txt3 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#F578C5").s().p("");
	this.shape.setTransform(104.9,23.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F578C5").s().p("");
	this.shape_1.setTransform(97.5,23.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F578C5").s().p("AgGA0IAAhnIANAAIAABng");
	this.shape_2.setTransform(91.3,22.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F578C5").s().p("AgSA0IALgcIgfhLIAQAAIAWA7IAXg7IAQAAIgqBng");
	this.shape_3.setTransform(85.7,24.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#F578C5").s().p("AgHA0IAAhAIgLAAIAAgNIALAAIAAgaIANAAIAAAaIANAAIAAANIgNAAIAABAg");
	this.shape_4.setTransform(79.8,22.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F578C5").s().p("");
	this.shape_5.setTransform(74.3,22.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F578C5").s().p("");
	this.shape_6.setTransform(62.6,23.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#F578C5").s().p("AgGA0IAAhnIANAAIAABng");
	this.shape_7.setTransform(56.4,22.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#F578C5").s().p("");
	this.shape_8.setTransform(50.2,22.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#F578C5").s().p("");
	this.shape_9.setTransform(40.1,23.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#F578C5").s().p("AgGA0IAAhnIANAAIAABng");
	this.shape_10.setTransform(33.8,22.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#F578C5").s().p("AgGA0IAAhNIANAAIAABNgAgGgiIAAgRIANAAIAAARg");
	this.shape_11.setTransform(30.5,22.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#F578C5").s().p("");
	this.shape_12.setTransform(23.8,23.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#F578C5").s().p("AgEAnIgfhNIAQAAIATA3IAAAAIAUg3IAQAAIgfBNg");
	this.shape_13.setTransform(15.4,23.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#F578C5").s().p("AAeA0IgMgfIgkAAIgLAfIgQAAIAnhnIANAAIAnBngAAOAHIgOgmIgMAmIAaAAg");
	this.shape_14.setTransform(6.9,22.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#F578C5").s().p("AgQAoIAAhNIAOAAIAAAHQAFgIAOgBIAAAPQgFAAgGADQgEACgCAEQgBAGAAAHIAAAqg");
	this.shape_15.setTransform(89.8,8.4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#F578C5").s().p("");
	this.shape_16.setTransform(82.4,8.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#F578C5").s().p("AgJA0IAAhAIgHAAIAAgNIAHAAIAAgEQAAgGACgEQACgFAFgDIAHgDIALgBIAAANQgIAAgDADQgDACAAAEIAAAEIAOAAIAAANIgOAAIAABAg");
	this.shape_17.setTransform(75.9,7.2);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#F578C5").s().p("");
	this.shape_18.setTransform(65.6,8.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#F578C5").s().p("AgHA0IAAhAIgLAAIAAgNIALAAIAAgaIANAAIAAAaIANAAIAAANIgNAAIAABAg");
	this.shape_19.setTransform(59.2,7.2);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#F578C5").s().p("AgGA0IAAhNIANAAIAABNgAgGgiIAAgRIANAAIAAARg");
	this.shape_20.setTransform(55.6,7.2);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#F578C5").s().p("");
	this.shape_21.setTransform(50.4,7.2);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#F578C5").s().p("");
	this.shape_22.setTransform(38.7,8.5);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#F578C5").s().p("");
	this.shape_23.setTransform(29.7,8.5);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#F578C5").s().p("");
...
// stage content:
(lib._336x280_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(62).to({_off:false},0).to({x:243},14,cjs.Ease.get(1)).wait(37));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/336x280_1_atlas_.png?1482444914547", id:"336x280_1_atlas_"}
	],
	preloads: []
};
