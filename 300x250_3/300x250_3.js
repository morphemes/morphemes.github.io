...
lib.ssMetadata = [
		{name:"300x250_3_atlas_", frames: [[152,0,100,34],[0,0,150,250]]}
];
...
(lib.logo = function() {
	this.spriteSheet = ss["300x250_3_atlas_"];
	this.gotoAndStop(0);
...
(lib.bg_leftpng_ = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FABBE2").s().p("ArtTiMAAAgnDIXbAAMAAAAnDg");
...
// stage content:
(lib._300x250_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(161,233.5,1,1.052,0,18.1,0,5,16.5);
	...
	this.instance_2.setTransform(162,233.5,1,1.052,0,18.1,0,5,16.5);
	...
	this.instance_3.setTransform(161,233.5,1,1.052,0,18.1,0,5,16.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_3_atlas_.png?1482437653923", id:"300x250_3_atlas_"}
	],
	preloads: []
};
