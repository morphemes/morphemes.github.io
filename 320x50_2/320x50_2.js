...
lib.ssMetadata = [
		{name:"320x50_2_atlas_", frames: [[0,0,320,50],[374,0,70,24],[322,0,50,45]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["320x50_2_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._320x50_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/320x50_2_atlas_.png?1482447575552", id:"320x50_2_atlas_"}
	],
	preloads: []
};
