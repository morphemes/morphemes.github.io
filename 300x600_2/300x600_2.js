...
lib.ssMetadata = [
		{name:"300x600_2_atlas_", frames: [[0,0,300,300],[0,604,100,34],[0,302,300,300]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["300x600_2_atlas_"];
	this.gotoAndStop(0);
...
(lib._300x600_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(58.1,332.5,1,1.052,0,18.1,0,5,16.5);
	...
	this.instance_1.setTransform(58.1,332.5,1,1.052,0,18.1,0,5,16.5);
	this.instance_1.alpha = 0.75;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(98).to({_off:false},0).to({x:243.6},8).to({_off:true},1).wait(6));

	// cta flicker copy
	this.instance_2 = new lib.flicker();
	this.instance_2.parent = this;
	this.instance_2.setTransform(58.1,332.5,1,1.052,0,18.1,0,5,16.5);
	...
	this.instance_3.setTransform(58.1,332.5,1,1.052,0,18.1,0,5,16.5);
	...
	this.instance_4.setTransform(-110,336.9,1.32,1.32,0,0,0,75,16.6);
	...
	this.instance_5.setTransform(-96,64);
	...
	this.instance_6.setTransform(-177.3,105.1,1,1,0,0,0,67.1,-7);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(40).to({_off:false},0).to({x:105.7},11,cjs.Ease.get(1)).wait(62));

	// txt - 2pairs
	this.instance_7 = new lib.txt2();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-158.8,178.3,1,1,0,0,0,44.8,26.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(44).to({_off:false},0).to({x:101.2},12,cjs.Ease.get(1)).wait(21).to({scaleX:1.1,scaleY:1.1,x:97.2,y:180.3},4).to({scaleX:1,scaleY:1,x:101.2,y:178.3},4).wait(28));

	// txt - 995
	this.instance_8 = new lib.txt2b();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-107.3,232.3,1.574,1.574,0,0,0,44.9,26.2);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(48).to({_off:false},0).to({x:145.7},12,cjs.Ease.get(1)).wait(21).to({scaleX:1.68,scaleY:1.68},4).to({scaleX:1.57,scaleY:1.57},4).wait(24));

	// txt - see site
	this.instance_9 = new lib.txt3();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-164.7,286.1,1,1,0,0,0,63.8,16);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_2_atlas_.png?1482949471524", id:"300x600_2_atlas_"}
	],
	preloads: []
};
