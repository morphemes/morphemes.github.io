...
lib.ssMetadata = [
		{name:"300x600_1_atlas_", frames: [[0,302,300,300],[0,604,100,34],[0,0,300,300]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["300x600_1_atlas_"];
	this.gotoAndStop(0);
...
(lib.txt3 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#F578C5").s().p("");
	this.shape.setTransform(212.8,9.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F578C5").s().p("");
	this.shape_1.setTransform(204.3,9.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F578C5").s().p("AgIA7IAAh1IAQAAIAAB1g");
	this.shape_2.setTransform(197.3,7.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F578C5").s().p("AgVA7IANggIgjhVIASAAIAZBDIAbhDIARAAIgvB1g");
	this.shape_3.setTransform(190.8,10.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#F578C5").s().p("AgJA7IAAhIIgMAAIAAgPIAMAAIAAgeIAQAAIAAAeIAPAAIAAAPIgPAAIAABIg");
	this.shape_4.setTransform(184,7.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F578C5").s().p("");
	this.shape_5.setTransform(177.8,7.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F578C5").s().p("");
	this.shape_6.setTransform(164.4,9.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#F578C5").s().p("AgIA7IAAh1IAQAAIAAB1g");
	this.shape_7.setTransform(157.3,7.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#F578C5").s().p("");
	this.shape_8.setTransform(150.1,8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#F578C5").s().p("");
	this.shape_9.setTransform(138.7,9.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#F578C5").s().p("AgIA7IAAh1IARAAIAAB1g");
	this.shape_10.setTransform(131.5,7.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#F578C5").s().p("AgHA7IAAhXIAQAAIAABXgAgHgnIAAgTIAQAAIAAATg");
	this.shape_11.setTransform(127.7,7.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#F578C5").s().p("");
	this.shape_12.setTransform(120,9.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#F578C5").s().p("AgFAsIgjhXIASAAIAWA+IABAAIAWg+IASAAIgjBXg");
	this.shape_13.setTransform(110.5,9.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#F578C5").s().p("AAiA7IgNgjIgpAAIgNAjIgTAAIAth1IAPAAIAtB1gAAPAJIgPgtIAAAAIgOAtIAdAAg");
	this.shape_14.setTransform(100.7,7.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#F578C5").s().p("AgSAtIAAhXIAQAAIAAAIQAGgKAPgBIAAARQgFABgHADQgEACgDAFQgBAGAAAJIAAAvg");
	this.shape_15.setTransform(88.7,9.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#F578C5").s().p("");
	this.shape_16.setTransform(80.4,9.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#F578C5").s().p("AgMA7IAAhIIgHAAIAAgPIAHAAIAAgFQAAgHADgFQADgFAFgDQAFgDAEgBIAMgBIAAAPQgIAAgEADQgDACgBAFIAAAFIAQAAIAAAPIgQAAIAABIg");
	this.shape_17.setTransform(72.9,7.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#F578C5").s().p("");
	this.shape_18.setTransform(61.1,9.4);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#F578C5").s().p("AgJA7IAAhIIgMAAIAAgPIAMAAIAAgeIAQAAIAAAeIAPAAIAAAPIgPAAIAABIg");
	this.shape_19.setTransform(53.7,7.9);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#F578C5").s().p("AgHA7IAAhXIAQAAIAABXgAgHgnIAAgTIAQAAIAAATg");
	this.shape_20.setTransform(49.6,7.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#F578C5").s().p("");
	this.shape_21.setTransform(43.7,7.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#F578C5").s().p("");
	this.shape_22.setTransform(30.3,9.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#F578C5").s().p("");
	this.shape_23.setTransform(20,9.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#F578C5").s().p("");
...
// stage content:
(lib._300x600_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(58.1,536,1,1.052,0,18.1,0,5,16.5);
	this.instance.alpha = 0.75;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(102).to({_off:false},0).to({x:247.1,y:535.9},8).to({_off:true},1).wait(2));

	// cta flicker copy 2
	this.instance_1 = new lib.flicker();
	this.instance_1.parent = this;
	this.instance_1.setTransform(58.1,536,1,1.052,0,18.1,0,5,16.5);
	this.instance_1.alpha = 0.75;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(98).to({_off:false},0).to({x:247.1,y:535.9},8).to({_off:true},1).wait(6));

	// cta flicker copy
	this.instance_2 = new lib.flicker();
	this.instance_2.parent = this;
	this.instance_2.setTransform(58.1,536,1,1.052,0,18.1,0,5,16.5);
	this.instance_2.alpha = 0.75;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(94).to({_off:false},0).to({x:247.1,y:535.9},8).to({_off:true},1).wait(10));

	// cta flicker
	this.instance_3 = new lib.flicker();
	this.instance_3.parent = this;
	this.instance_3.setTransform(58.1,536,1,1.052,0,18.1,0,5,16.5);
	this.instance_3.alpha = 0.75;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(89).to({_off:false},0).to({x:247.1,y:535.9},8).to({_off:true},1).wait(15));

	// shop now
	this.instance_4 = new lib.ctapng_();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-100.4,540.9,1.32,1.32,0,0,0,75,16.6);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(62).to({_off:false},0).to({x:150},14,cjs.Ease.get(1)).wait(37));

	// logoend
	this.instance_5 = new lib.logo_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(358,64);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(35).to({_off:false},0).to({x:215},11,cjs.Ease.get(1)).wait(67));

	// txt - new vip
	this.instance_6 = new lib.txt1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-155.8,323,1,1,0,0,0,67.1,-7);
	...
	this.instance_7.setTransform(-148.1,396.2,1,1,0,0,0,44.8,26.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(44).to({_off:false},0).to({x:100.8},12,cjs.Ease.get(1)).wait(21).to({scaleX:1.1,scaleY:1.1,x:99.3,y:397.7},4).to({scaleX:1,scaleY:1,x:100.8,y:396.2},4).wait(28));

	// txt - 995
	this.instance_8 = new lib.txt2b();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-98.3,450.3,1.574,1.574,0,0,0,44.9,26.2);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(48).to({_off:false},0).to({x:144.7},12,cjs.Ease.get(1)).wait(21).to({scaleX:1.67,scaleY:1.67,x:144.2,y:451.2},4).to({scaleX:1.57,scaleY:1.57,x:144.7,y:450.3},4).wait(24));

	// txt - see site
	this.instance_9 = new lib.txt3();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-153.6,504,1,1,0,0,0,63.8,16);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(52).to({_off:false},0).to({x:101.8},12,cjs.Ease.get(1)).wait(49));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_1_atlas_.png?1482949526953", id:"300x600_1_atlas_"}
	],
	preloads: []
};
