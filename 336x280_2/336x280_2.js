...
lib.ssMetadata = [
		{name:"336x280_2_atlas_", frames: [[0,0,168,280],[0,282,100,34],[170,0,168,280]]}
];
...
(lib.bg_left = function() {
	this.spriteSheet = ss["336x280_2_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib._336x280_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/336x280_2_atlas_.png?1482444933750", id:"336x280_2_atlas_"}
	],
	preloads: []
};
